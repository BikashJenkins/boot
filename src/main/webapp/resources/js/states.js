...
var handles = ["Select","Andaman and Nicobar Islands",
                        "Andhra Pradesh",
                        "ArunachalPradesh",
                        "Assam",
                        "Bihar",
...
function select_district($val)
{
  ...
  $('#district').html(options);
   ...
   var andaman = ["Select","Nicobar","North and Middle Andaman","South Andaman"];
   $(function() {
  var options = '';
 ...
 if($val=='Andhra Pradesh') {
  ...
  if ($val=='Arunachal Pradesh') {
    var ap = ["Select","Anjaw","Changlang","Dibang Valley","East Siang","East Kameng","Kurung Kumey","Lohit","Longding","Lower Dibang Valley","Lower Subansiri","Papum Pare","Tawang","Tirap","Upper Siang","Upper Subansiri","West Kameng","West Siang"];
   $(function() {
  var options = '';
